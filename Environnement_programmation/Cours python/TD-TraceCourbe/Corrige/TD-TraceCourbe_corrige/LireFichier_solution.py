...
#
dataFileName = "data001.txt"
lu = []
f  = open(dataFileName, 'r')
for line in f:
    if line[0] != "#":  # la ligne lue n'est pas un commentaire
        lu.append(line)
f.close()
...
imageFileName = dataFileName.replace("txt", "png")  # nom du fichier image
plt.savefig(imageFileName,format="png")
